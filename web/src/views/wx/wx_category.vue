        ...
        <Modal  title="编辑"  :mask-closable="false" :closable="false" v-model="modalAdd">
            <Form ref="formRef" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="小图标" prop="icon_url">
                    <img :src="imgDataUrl1" style="width: 50px">
                    <Upload :before-upload="handleUpload1" action="" accept="image/*">
                        <Button type="ghost" icon="ios-cloud-upload-outline">上传图片</Button>
                    </Upload>
                    <Tag type="border">图片大小为：90*90</Tag>
                </FormItem>
                <FormItem label="背景图" prop="wap_banner_url">
                    ...
                    <Tag type="border">图片大小为：750*250</Tag>
                </FormItem>
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    ...
                    wap_banner_url: [
                        { required: true, message: '背景图为必填项', trigger: 'blur' }
                    ],
                    front_name: [
